...
echo "  <title>NCSU Horticulture eCard Site</title>\n"; 
echo "\n"; 
...
echo "<h4>Choose an image to send a card</h4>\n";
echo "<br><br><br>\n"; 
echo "<ul class=\"tabs\">\n"; 
...
foreach($xml->category as $child)
  {
	...
	echo('<div>');
		...
		{
			$greeting = $child->displayname;
			echo ('<a href="test.php?type='.$values.'&greet='.$greeting.'">');
