...
$email_message .= <<<EOF
															...
															<br>
EOF;
$image_source = '<img src="http://ecard.comule.com/flowers'.$image.'image.jpg" style="max-width:600px;" mc:label="postcard_image" mc:edit="postcard_image" mc:allowtext />';
echo $image_source;
$email_message .= $image_source;
$email_message .= <<<EOF
                                                            <br><br>
EOF;
$email_message .= $desc;
